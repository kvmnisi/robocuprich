...
class Agent(Base_Agent):
    ...
    """
Complete select_skill implementation constrained to ONLY using:
- self.move(target_2d, orientation, ...)
- self.kickTarget(strategyData, mypos_2d, target_2d, ...)

All intelligence is in WHAT we pass to these functions, not HOW they work.
"""
